        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card title="Accuracy Trend">
            <div className="h-64 flex items-end justify-between gap-2 px-4 pb-4">
              {[45, 50, 48, 55, 60, 58, 65, 70, 72, 75].map((h, i) =>
              <div
                key={i}
                className="w-full bg-teal-100 rounded-t-sm relative group">

                  <div
                  className="absolute bottom-0 w-full bg-teal-500 rounded-t-sm transition-all duration-500"
                  style={{
                    height: `${h}%`
                  }}>
                </div>
