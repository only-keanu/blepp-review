...
const MOCK_QUESTIONS: Question[] = [{
  ...
  explanation: 'Psychoanalysis, developed by Sigmund Freud, emphasizes unconscious processes and early childhood experiences as the primary drivers of behavior.',
  difficulty: 'medium',
  source: 'ai',
  tags: ['theories']
}, {
  ...
  choices: ['Panic Disorder', 'Generalized Anxiety Disorder', 'Specific Phobia', 'Obsessive-Compulsive Disorder'],
  correctAnswerIndex: 2,
  explanation: 'Specific Phobia is characterized by marked fear or anxiety about a specific object or situation (e.g., flying, heights, animals, injections, blood).',
  difficulty: 'easy',
  source: 'ai',
  tags: ['disorders']
}];
export function PracticePage() {
  ...
  return <AppLayout>
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        {/* Main Content */}
        {!isSubmitted ? <QuestionCard question={currentQuestion} selectedAnswerIndex={selectedAnswer} onSelectAnswer={handleSelectAnswer} onSubmit={handleSubmit} isSubmitting={false} /> : <AnswerFeedback question={currentQuestion} selectedAnswerIndex={selectedAnswer!} onNext={handleNext} />}
      </div>
    </AppLayout>;
}