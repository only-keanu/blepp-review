...
export function FlashcardView({
  ...
  return <div className="w-full max-w-2xl mx-auto perspective-1000">
      <div className="relative h-96 w-full cursor-pointer transition-all duration-500 transform-style-3d" onClick={handleFlip} style={{
      transform: isFlipped ? 'rotateY(180deg)' : 'rotateY(0deg)'
        ...
        {/* Back */}
        <div className="absolute inset-0 h-full w-full backface-hidden bg-slate-900 rounded-2xl shadow-lg p-8 flex flex-col items-center justify-center text-center transform rotate-y-180" style={{
      ...
      <div className={`mt-8 transition-opacity duration-300 ${isFlipped ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
        ...
        <div className="flex justify-center gap-4">
          <Button variant="outline" className="border-red-200 hover:bg-red-50 text-red-700 hover:border-red-300" onClick={e => {
          e.stopPropagation();
          onRate('low');
          setIsFlipped(false);
          ...
          <Button variant="outline" className="border-amber-200 hover:bg-amber-50 text-amber-700 hover:border-amber-300" onClick={e => {
          e.stopPropagation();
          onRate('medium');
          setIsFlipped(false);
          ...
          <Button variant="outline" className="border-green-200 hover:bg-green-50 text-green-700 hover:border-green-300" onClick={e => {
          e.stopPropagation();
          onRate('high');
          setIsFlipped(false);
