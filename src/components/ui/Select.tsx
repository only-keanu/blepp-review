      ...
      <div className="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
        ...
        <div className="sticky top-0 z-10 bg-white px-2 py-1.5 border-b border-slate-100">
              <div className="relative">
                ...
                <input
              type="text"
              className="w-full rounded-md border border-slate-300 py-1.5 pl-8 pr-3 text-sm focus:border-teal-500 focus:outline-none focus:ring-1 focus:ring-teal-500"
              placeholder="Search..."
              value={search}
